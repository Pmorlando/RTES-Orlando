// Written by Sam Siewert Modified by Phil Orlando for exercise 3
// compiled with gcc posix_mq.c -o posix_mq
...
void main(void)
{
  ...
  rt_max_prio = sched_get_priority_max(SCHED_FIFO);// already sched fifo but would have changed these 
